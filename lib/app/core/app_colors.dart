...
class AppColors {
  ...
  static final Color background = Color(0xFF9BD6EE);
  static final Color blueAccent = Color(0xFF5EC2FF);
  static final Color blue = Color(0xFF5B92F5);
  static final Color darkBlue = Color(0xFF1D5F94);
